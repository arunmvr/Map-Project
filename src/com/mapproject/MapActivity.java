	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (choice == 0) {
			...
			if (status != ConnectionResult.SUCCESS) {
				...
				googlemap = fm.getMap();
				googlemap.setMyLocationEnabled(true); // Set true to get current
														// location
				googlemap.getUiSettings().setZoomControlsEnabled(true); // Set
																		// true
																		// to
																		// display
																		// Zoom
																		...
																		// out
																		// Button
				googlemap.getUiSettings().setCompassEnabled(true); // Set true
																	// to
																	// display
																	// Compass
				...
				try {
					gps_enabled = locationManager
							.isProviderEnabled(LocationManager.GPS_PROVIDER); // Check
																				// if
																				// location
																				// is
																				// enabled
				...
				try {
					network_enabled = locationManager
							.isProviderEnabled(LocationManager.NETWORK_PROVIDER); // Check
																					// if
																					// network
																					// is
																					// enabled
				...
				if (location != null) {
					...
					locationManager.requestLocationUpdates(provider, 20, 0,
							this);
